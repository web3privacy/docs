...
Over the past two years, we have experimented with various governance models. Below, we share our findings, highlighting our missteps to serve as lessons for others.

# Current Governance System:



# Previous Governance System (ineffective):
