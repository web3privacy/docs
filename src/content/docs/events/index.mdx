...
<LinkCard title="Events page on website" href="https://web3privacy.info/events" />
![screenshot of Events webpage](../assets/events-list.png)

## Related Links

<LinkCard title="JSON output of data codebase" href="https://data.web3privacy.info" />
<LinkCard title="Summary of Event Seasons" href="/events/seasons" />
<LinkCard title="Event Types specifications" href="/events/types" />
<LinkCard title="Event Formats specifications" href="/events/formats" />
<LinkCard title="Event Call for Proposals (cfp) specifications" href="/events/types" />
<LinkCard title="Event Recording guidelines" href="/events/recording" />
<LinkCard title="Event Production guidelines" href="/events/types" />
...
We divide events into different types according to their length and purpose. These different types are reflected in the event codes above and you can find out more on a dedicated Event Types documentation page:
