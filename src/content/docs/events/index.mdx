...
Please do read this docs page in full, respect the naming convention noted here, and follow fully the [how to add an event to website guide](/contributors/add-event-to-website)
