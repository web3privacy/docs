...
| Privacy use-cases ideation framework for devs | _Framework for facilitation privacy use-cases (privacy services modelling)_ | [Pagency](https://github.com/web3privacy/web3privacy/tree/main/Pagency) |
